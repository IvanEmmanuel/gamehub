...
from ..views.management import ( GameManageView, GameTrailerListView, GameTrailerCreateView, GameTrailerUpdateView, 
                                ...
                                GameGuideCreateView, GameGuideUpdateView, GameGuideDeleteView, GameGuideReorderView, GamePatchNoteListView,
                                GamePatchNoteCreateView, GamePatchNoteUpdateView, GamePatchNoteDeleteView, GamePatchNoteReorderView
                                )
...
urlpatterns = [
    ...
    path("games/<int:pk>/patch-notes/", GamePatchNoteListView.as_view(), name="game_patch_note_list",),
    path("games/<int:pk>/patch-notes/create/", GamePatchNoteCreateView.as_view(), name="game_patch_note_create",),
    path("games/<int:pk>/patch-notes/<int:patch_note_id>/edit/", GamePatchNoteUpdateView.as_view(), name="game_patch_note_update",),
    path("games/<int:pk>/patch-notes/<int:patch_note_id>/delete/", GamePatchNoteDeleteView.as_view(), name="game_patch_note_delete",),
    path("games/<int:pk>/patch-notes/reorder/", GamePatchNoteReorderView.as_view(), name="game_patch_note_reorder",),
]